...
This is the main loop for the balance bot. It can be thought to run in three states\+: Initialization, Read from pitch the IMU, Send pitch to the PID Controller, and Send a PWM signal to the motors. \texorpdfstring{$<$}{<} Resets IMU\Hypertarget{main_8c_a70af21c671abfcc773614a9a4f63d920}\index{main.c@{main.c}!SystemClock\_Config@{SystemClock\_Config}}
